...
```{r}
train.dtm <- as.matrix(DocumentTermMatrix(corpus,control=list(wordLengths=c(1,Inf))))

test.dtm <- as.matrix(DocumentTermMatrix(test_corpus,control=list(wordLengths=c(1,Inf))))
