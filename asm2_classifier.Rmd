...
# required packages
packages <- c('dplyr','tidyverse', 'tidymodels', 'tidytext', 'discrim','naivebayes', "textrecipes", "kernlab", "splitstackshape", "e1071", "glmnet", "caret")
...
write.csv(output, "predictions.csv_4", row.names = FALSE, quote = F)
```
